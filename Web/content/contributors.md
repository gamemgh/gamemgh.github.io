...
+++
# %title%
This is a list of contributors who has assisted the game better. Looking for ways to contribute? Remember, even feedbacks and suggestions count in contribution. Check [how to contribute]({{% ref "contribute.md" %}}).

## General
- [Harry Min Khant](https://harrymkt.github.io): Project founder, the core developer.
- [Sam Tupy](https://samtupy.com/): Developer of [NVGT (NonVisual Gaming Toolkit)](https://nvgt.dev), the game engine this game utilizes to develop.
...
- Lastly, yet to be listed, thanks everybody who play this game and their suggestions. Without user suggestions and above contributors it would have been impossible for the game to be what it is now.
